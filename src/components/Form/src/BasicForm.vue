...
export default defineComponent({
  name: 'BasicForm',
  components: { FormItem, ElForm, ElRow, FormAction },
  props: basicProps,
  emits: ['advanced-change', 'reset', 'submit', 'register'],
  setup(props, { emit, attrs, slots, expose }) {
    const { showActionBtn } = unref(props);
    ...
    // Get uniform row style and ElRow configuration for the entire form
...
.@{prefix-cls} {
  .el-form-item {
    ...
    &:not(.el-form-item-with-help) {
      margin-bottom: 20px;
    }

    &.suffix-item {
      .el-form-item-children {
        display: flex;
      }
