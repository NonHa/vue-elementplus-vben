<script lang="tsx">
  ...
  import { ElMenu, ElDivider, ElMenuItem, ElSubMenu } from 'element-plus';
    ...
    setup(props) {
      ...
      function renderMenuItem(items: ContextMenuItem[]) {
        return items.map((item) => {
          ...
          return (
            <ElSubMenu index={label} disabled={disabled} popperClass={`${prefixCls}__popup`}>
              {{
      ...
      return () => {
        ...
        return (
          <div class={prefixCls}>
            <ElMenu mode="vertical" collapse ref={wrapRef} style={unref(getStyle)}>
...
<style lang="less">
  ...
  .item-style() {
    li {
      ...
      &:not(.el-menu-item-disabled):hover {
